...
void tFigure::set_opt(int a,int b,int c, int g)
{
...
mas[6]=new tTria;
       ...
       mas[1]->set_opt(30,30,60,80);
       mas[2]->set_opt(100,100,150,150);
       mas[3]->set_opt(200,200,30,30);
       mas[4]->set_opt(400,250,40,20);
       mas[5]->set_opt(0,0,50,30);
       mas[6]->set_opt(600,250,550,300);
