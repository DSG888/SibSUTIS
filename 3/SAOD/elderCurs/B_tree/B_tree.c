...
void usage_2( void )
{
	...
	printf("\033[0m\t\033[31mi <k>\033[30;1m  -- Insert <k> (an integer)"
						" as both key and value).\n");
	printf("\033[0m\t\033[31mf <k>\033[30;1m  -- Find the value under "
						"key <k>.\n");
	printf("\033[0m\t\033[31mr <k1> <k2>\033[30;1m -- Print the keys and"
						" values found in the range [<k1>, <k2>\n");
	printf("\033[0m\t\033[31md <k>\033[30;1m  -- Delete key <k> and its "
						"associated value.\n");
	printf("\033[0m\t\033[31mx\033[30;1m -- Destroy the whole tree. Start"
						" again with an empty tree of the same order.\n");
	printf("\033[0m\t\033[31mt\033[30;1m -- Print the B+ tree.\n");
	printf("\033[0m\t\033[31mq\033[30;1m -- Quit. (Or use Ctl-D.)\n");
	printf("\033[0m\t\033[31m?\033[30;1m -- Print this help message.\n");
	printf("-------------------------------------------------"
					 "-------------------------------\033[0m\n");
}
...
void find_and_print_range( node * root, int key_start, int key_end, bool verbose )
{
	...
	else
	{
		for (i = 0; i < num_found; i++)
			printf("Key: %d   Location: %lx  Value: %d\n", returned_keys[i], (unsigned long)returned_pointers[i], ((record *)returned_pointers[i])->value);
	}
}
