...
plot "RemovalBSTreeRand.dat" using 1:2 title "BSTree Rand" with linespoints ls 1,\
     "RemovalRBTreeRand.dat" using 1:2 title "RBTree Rand" with linespoints ls 2,\
     "RemovalAATreeRand.dat" using 1:2 title "AATree Rand" with linespoints ls 3,\
     "RemovalBSTreeSort.dat" using 1:2 title "BSTree Sort" with linespoints ls 4,\
     "RemovalRBTreeSort.dat" using 1:2 title "RBTree Sort" with linespoints ls 5,\
     "RemovalAATreeSort.dat" using 1:2 title "AATree Sort" with linespoints ls 6
