...
plot "SearchBSTreeRand.dat" using 1:2 title "BSTree Rand" with linespoints ls 1,\
     "SearchRBTreeRand.dat" using 1:2 title "RBTree Rand" with linespoints ls 2,\
     "SearchAATreeRand.dat" using 1:2 title "AATree Rand" with linespoints ls 3,\
     "SearchBSTreeSort.dat" using 1:2 title "BSTree Sort" with linespoints ls 4,\
     "SearchRBTreeSort.dat" using 1:2 title "RBTree Sort" with linespoints ls 5,\
     "SearchAATreeSort.dat" using 1:2 title "AATree Sort" with linespoints ls 6
