/*
В следующем примере кода демонстрируется использование указанной области данных для хранения 
 информации о потоках.
*/
using System;
...
//    public static void SlotTest()
    public void SlotTest()
    {
        ...
        Thread.SetData(
//            Thread.GetNamedDataSlot("Random"), cnt);
