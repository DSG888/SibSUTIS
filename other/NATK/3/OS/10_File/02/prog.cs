...
public class RecursiveFileProcessor 
{
    ...
    {
        Console.WriteLine("Копирование заданного файла из заданного каталога в текущий каталог:");
	...
	File.Copy(path, args[1]);
        Console.WriteLine("Заданный файл {0} успешно скопирован в текущий каталог.", path);
    }
