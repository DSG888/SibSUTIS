...
//        string path = @"MyTest.txt";
        ...
        Console.WriteLine("Переместить объединённый файл из нового каталога в текущий.");
        Console.WriteLine("Установить атрибуты перемещённого файла только для чтения.");
...
//	    path = args[2] + "\\" + args[1];
	    File.Delete(path1);
            Console.WriteLine("Файл {0} из каталога {1} успешно удалён.", path1, args[0]);
