...
public class RecursiveFileProcessor 
{
    ...
    {
        Console.WriteLine("Перемещениение заданного файла из заданного каталога в другой каталог:");
	...
	File.Move(path, path1);
        Console.WriteLine("Заданный файл {0} успешно перемещён из каталога {1} в каталог {2}.", args[1], path, path1);
    }
