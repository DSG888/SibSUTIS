...
public class RecursiveFileProcessor 
{
    ...
    {
        Console.WriteLine("Копирование заданного файла из текущего каталога в заданный каталог:");
	...
	File.Copy(args[1], path);
        Console.WriteLine("Заданный файл {0} успешно скопирован в заданный каталог{1}.", args[1], path);
    }
