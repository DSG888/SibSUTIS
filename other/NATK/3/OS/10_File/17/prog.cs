...
//        string path = @"MyTest.txt";
        ...
        if(args.Length != 4)
        {
            ...
            Console.WriteLine("Используйте: prog.exe (имя каталога) (имя файла) (новое имя каталога) (имя перемещаемого файла)");
            return;
        }
...
///            File.Delete(path2);
	    ...
	    Directory.Delete(args[2]);
            Console.WriteLine("Каталог {0} успешно удалён.", args[2]);
	    ...
	    //Удалить файл
	    File.Delete(args[3]);
            Console.WriteLine("Файл {0} успешно удалён.", args[3]);
/*
