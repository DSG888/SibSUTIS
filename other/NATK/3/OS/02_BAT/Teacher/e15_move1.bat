...
echo === Перемещение файла %3 из каталога %1 в каталог %2 ===	
move %1\%3 %2\
goto exit			
: no_param1			
echo Должен быть задан каталог, откуда перемещается файл 
goto exit			
: no_param2			
echo Должен быть задан каталог, куда перемещается файл 
goto exit			
: no_param3			
echo Должен быть задан перемещаемый файл из каталога %1
goto exit			
: not_exist1			
