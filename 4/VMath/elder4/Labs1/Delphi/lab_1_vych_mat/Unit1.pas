...
x0[1,2]:=2;
x0[2,2]:=1;
while (abs(x0[1,1]-x0[1,2])>0.000001) and (abs(x0[2,1]-x0[2,2])>0.000001)do begin
x0[2,1]:=x0[2,2];
x0[1,1]:=x0[1,2];
...
memo1.Lines.Add('шаг'+' ' +inttostr(s1)+' епта   значения x1   '+floattostr(x0[1,2])+'  значения x2    '+floattostr(x0[2,2]));
end;
end;
